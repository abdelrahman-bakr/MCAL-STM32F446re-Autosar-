...
#define DioConf_BUTTON_PORT_NUM             (Dio_PortType)2 /* PORT C */

/* DIO Configured Channel ID's */
#define DioConf_LED_CHANNEL_NUM             (Dio_ChannelType)5 /* Pin 5 in PORTA */
#define DioConf_BUTTON_CHANNEL_NUM          (Dio_ChannelType)13 /* Pin 13 in PORTC */
